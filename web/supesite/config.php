...
$_SC['dbuser'] = 'a0314225158';					//SupeSite数据库用户名
$_SC['dbpw'] = '59667799';						//SupeSite数据库密码
$_SC['dbname'] = 'a0314225158';						//SupeSite数据库名
$_SC['tablepre'] = 'supe_';					//SupeSite表名前缀(不能与论坛的表名前缀相同)
$_SC['pconnect'] = 0;						//SupeSite数据库持久连接 0=关闭, 1=打开
$_SC['dbcharset'] = 'utf8';					//SupeSite数据库字符集

$_SC['siteurl'] = 'http://canyouhike.me/supesite';						//SupeSite程序文件所在目录的URL访问地址。可以填写以 http:// 开头的完整URL，也可以填写相对URL。末尾不要加 /。如果程序无法自动获取，请务必手工修改为 http://www.yourwebsite.com/supesite 形式
...
define('UC_DBUSER', 'a0314225158');					// UCenter 数据库用户名
define('UC_DBPW', '59667799');						// UCenter 数据库密码
define('UC_DBNAME', 'a0314225158');					// UCenter 数据库名称
define('UC_DBCHARSET', 'utf8');					// UCenter 数据库字符集
define('UC_DBTABLEPRE', '`a0314225158`.uc_');					// UCenter 数据库表前缀
define('UC_DBCONNECT', '0');					// UCenter 数据库持久连接 0=关闭, 1=打开

// 通信相关
define('UC_KEY', 'A4W9E0c1c3t6LeU8w467W2E3l4V9Y114R4Qa6554t8p9Nft1kcb4W6l9y3Kanc2d');						// 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://canyouhike.me/uc');						// UCenter 的 URL 地址, 在调用头像时依赖此常量
