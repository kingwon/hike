...
<?php block("category", "type/$key/isroot/1/order/c.displayorder/limit/0,12/cachetime/80800/cachename/category"); ?><ul><li>
...
</div><!--col1 end--><?php block("spacenews", "type/news/digest/1,2,3/order/i.viewnum DESC,i.dateline DESC/limit/0,6/cachetime/89877/subjectlen/34/subjectdot/0/cachename/hotnews2"); ?><div class="col2">
...
<?php if(is_array($channels['menus'])) { foreach($channels['menus'] as $key => $value) { ?>
<?php if($value['upnameid']=='news') { ?>
<div class="column">
<div class="col1">
<div class="global_module">
<div class="global_module1_caption"><h3><?=$value['name']?></h3><a class="more" href="<?php echo geturl("action/$key"); ?>">更多&gt;&gt;</a></div>
<ul class="global_tx_list1"><?php block("spacenews", "type/$key/order/i.dateline DESC/limit/0,12/cachetime/86900/subjectlen/40/subjectdot/0/showdetail/1/messagelen/100/messagedot/1/cachename/hotnews"); ?>
<?php if(is_array($_SBLOCK['hotnews'])) { foreach($_SBLOCK['hotnews'] as $value) { ?>
<li><span class="box_r"><?php sdate('m-d',$value[dateline]); ?></span><a href="<?=$value['url']?>" title="<?=$value['subjectall']?>"><?=$value['subject']?></a></li>
<?php } } ?>
</ul>
</div>
</div><!--col1 end--><?php block("spacenews", "type/$key/digest/1,2,3/order/i.viewnum DESC,i.dateline DESC/limit/0,6/cachetime/89877/subjectlen/34/subjectdot/0/cachename/hotnews2"); ?><div class="col2">
<div class="global_module bg_fff">
<div class="global_module2_caption"><h3>本月精华</h3></div>
<ul class="global_tx_list2">
<?php if(is_array($_SBLOCK['hotnews2'])) { foreach($_SBLOCK['hotnews2'] as $value) { ?>
